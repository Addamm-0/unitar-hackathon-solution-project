...
TestimonialCard2.defaultProps = {
  rootClassName: '',
  quote:
    "I've tried other online learning platforms,but none of come close to inclusolve.the keyboard navigation is so smooth and screenreader compatibility is flawless.I can access everyjing with ease,from courses to forums to FAQs page.The diverse source of learning styles nd resources is also inspiring.It's clear that inclusolve was designed for people like me in mind and am gratefull for that.",
  profileSrc:
